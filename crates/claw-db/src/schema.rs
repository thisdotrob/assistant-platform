...
const BASELINE: &[(&str, &str, &str)] = &[
    ("claw-permissions", "users_roles_dms", PERMISSIONS_V1),
    ("claw-agent-graph", "agent_graph_core", AGENT_GRAPH_V1),
    ("claw-session", "sessions", SESSION_V1),
    ("claw-approvals", "questions_approvals", APPROVALS_V1),
    ("claw-router", "dropped_messages", ROUTER_V1),
    ("claw-scheduler", "scheduled_projection", SCHEDULER_V1),
    ("claw-runtime-docker", "container_runs", RUNTIME_DOCKER_V1),
    ("claw-memory", "memory_health", MEMORY_V1),
    ("claw-capabilities", "capability_metadata", CAPABILITIES_V1),
];
