//! claw-channel-slack: the Slack product channel.
//!
//! Offline, deterministic core: normalizing Slack event payloads into the
//! platform's neutral [`claw_router::RoutingEvent`] and rendering outbound
...
pub const MODULE_ID: &str = "claw-channel-slack";
