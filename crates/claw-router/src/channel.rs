...
//! implements.
//!
//! claw-router owns these because it is the one consumer that evaluates routing
//! and engagement against normalized events, and every channel crate already
//! depends on claw-router. The types are self-contained (no claw-agent-protocol
