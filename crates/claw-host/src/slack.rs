...
use claw_memory::{SourceChannel, SourceRef};
use claw_permissions::{evaluate_sender, UnknownPolicy};
use claw_router::{
...
use claw_session::{InboundMessage, OutboundMessage, SessionLayout};
...
/// `content` (the serde body of [`claw_agent_protocol::OutboundAction::ScheduleMessage`]
...
mod live {
    ...
    use crate::error::HostError;
    use claw_channel_slack::{ProxyInjection, SlackChannel, TungsteniteOpener};
    use claw_runtime_docker::DockerCliRuntime;
