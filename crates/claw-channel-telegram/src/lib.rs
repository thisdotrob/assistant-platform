//! claw-channel-telegram: the Telegram product channel.
//!
//! This slice implements the offline, deterministic core: normalizing Telegram
//! `Update` payloads into the platform's neutral [`claw_router::RoutingEvent`]
...
pub const MODULE_ID: &str = "claw-channel-telegram";
