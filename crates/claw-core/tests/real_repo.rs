...
//!
//! claw-core lives at `<platform_root>/crates/claw-core`, so the platform root
//! is two directories up from `CARGO_MANIFEST_DIR`.

use std::collections::BTreeSet;
use std::path::PathBuf;

use claw_core::compat::{load_platform_manifest, load_prompt_fragment_manifest, scan_contracts};
