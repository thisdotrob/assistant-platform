...
//!
//! Delegation traffic rides the same `assistant-session` inbound/outbound DBs as
...
impl From<assistant_session::SessionError> for RoutingError {
    fn from(value: assistant_session::SessionError) -> Self {
