...
use assistant_agent_graph::audit::AuditEvent;
use assistant_agent_graph::handoff::{
...
use assistant_agent_graph::job::{
    cancel_grace_exceeded, is_timed_out, JobBudget, JobEvent, JobStatus, SpecialistJob,
};
use assistant_agent_graph::readiness::{no_orphaned_jobs, CheckStatus};
use assistant_agent_graph::registry::{ProfileLimits, RegisteredProfile, SpecialistRegistry};
use assistant_agent_graph::routing::{
...
fn full_delegation_round_trip() {
    ...
    let mut handoff = assistant_agent_graph::HandoffPacket::new("Find the latest invoice total");
