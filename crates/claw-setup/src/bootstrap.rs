...
use claw_config::{Config, InstanceLayout};
use claw_db::{apply, open_central, record_versions, MigrationSet, VersionRecord};
...
fn execute_step(
    ...
    match step {
        ...
        StepId::WriteConfig => {
            ...
            claw_config::write_config(&path, &input.config)?;
