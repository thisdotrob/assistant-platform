//! Docker runtime for agent runners: image naming and the `assistant-base`
...
//! `assistant-session`: the host (which does) resolves session paths and passes them
...
pub const MODULE_ID: &str = "assistant-runtime-docker";
