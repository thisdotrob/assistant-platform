...
//!
//! Reading the session DB is why this crate depends on assistant-session; the central
//! writes reuse the [`crate::projection`] upserts.

use rusqlite::Connection;

use assistant_session::{open_inbound, SessionError, SessionLayout};
...
mod tests {
    ...
    use assistant_session::{enqueue_inbound, init_session, InboundMessage};
