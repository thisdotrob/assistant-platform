...
//!
//! assistant-scheduler owns the wording the orchestrator uses when it talks about
...
//! crate, assistant-scheduler exposes only the fragment's id, order, and body — it
//! does NOT depend on assistant-agent-protocol. The agent-protocol assembler (or the
...
/// keeps the crate free of a dependency on assistant-agent-protocol's substituter
