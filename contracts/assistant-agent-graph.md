# assistant-agent-graph Contract
...
## Config
Reads specialist creation policy and delegation limits from assistant-config; specialist profiles are supplied by capability modules.
...
## Prompt Fragments
None of its own; consumes specialist-output protocol fragments owned by assistant-agent-protocol.
