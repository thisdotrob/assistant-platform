...
Owns no database tables directly in PR 0/1. Reads through claw-db, claw-session, and other modules' APIs.

## Config
Reads CLI output and verbosity defaults from claw-config; owns no schema of its own.
