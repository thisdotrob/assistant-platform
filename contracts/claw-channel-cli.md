...
## Config
Reads the local channel enablement flag from claw-config.

## Events
Receives platform events and emits normalized inbound messages into the router.

## CLI/Web Surfaces
None beyond the local terminal channel itself; operator commands belong to claw-cli.
